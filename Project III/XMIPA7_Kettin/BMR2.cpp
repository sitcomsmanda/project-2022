...
double kalkulasi_hasil (double bmr);
...
double kalkulasi_bmr ( int berat_badan, int tinggi_badan, int usia, int gender) {
    switch(gender){
        case 1 : return 66 + (13.7 * berat_badan) + (5 * tinggi_badan) - (6.8 * usia);
        case 2 : return 655 + (9.6 * berat_badan) + (1.8 * tinggi_badan) - (4.7 * usia);
        default : return 0;
    }
